...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("14. Cerrar aplicacion\n");

	}
	/**
	 *  Le muestra al usuario el pais del atleta que el usuario selecciono 
	 */
	private void ejecutarPaisAtleta()
	{
		System.out.println("\n" + "Pais del atleta ingresado" + "\n");
		
		String nameAtleta = input("Por favor ingrese el nombre del atleta");
		Atleta atleta = calculadora.buscarAtleta(nameAtleta);
